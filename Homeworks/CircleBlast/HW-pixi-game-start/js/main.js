...
function createLabelsAndButtons(){
    ...
    startButton.on("pointerour", e => e.currentTarget.alpha = 1.0);
	...
	for(let c of circles){
        for(let b of bullets){
            if(rectsIntersect(c,b)){
                fireballSound.play();
                createExplosions(c.x,c.y,64,64);
...
function createExplosions(x,y,frameWidth,frameHeight){
    let w2 = frameWidth/2;
